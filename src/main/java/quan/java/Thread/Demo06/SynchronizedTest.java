...
//    synchronizedThis1 end
    private static void test01(final SynchronizedTest t,final SynchronizedTest t1){
...
//    synchronizedStaticMethod end
    private static void test02(final SynchronizedTest t,final SynchronizedTest t1){
        Thread th = new Thread(new Runnable() {
...
//    synchronizedThis2 end
    private static void test03(final SynchronizedTest t,final SynchronizedTest t1){
        Thread th = new Thread(new Runnable() {
...
//    synchronizedMethod end
    private static void test04(final SynchronizedTest t,final SynchronizedTest t1){
        Thread th = new Thread(new Runnable() {
